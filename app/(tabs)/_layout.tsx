...
export default function TabsLayout() {
  return (
    <Tabs screenOptions={{
      ...
      <Tabs.Screen name="layouts" options={{
        title: 'Layout',
        tabBarIcon: ({ color, size }) => <Ionicons name="grid" size={size}
        color={color} />,
      }} />
       <Tabs.Screen name="flexbox" options={{
        title: 'Flexbox',
        tabBarIcon: ({ color, size }) => <Ionicons name="layers" size={size}
        color={color} />,
      }} />
      <Tabs.Screen name="contacts" options={{
        title: 'Contacts',
        tabBarIcon: ({ color, size }) => <Ionicons name="people" size={size}
        color={color} />,
      }} />
      <Tabs.Screen name="playground" options={{
        title: 'Composants',
        tabBarIcon: ({ color, size }) => <Ionicons name="book" size={size}
        color={color} />,
      }} />
